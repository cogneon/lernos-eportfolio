...
# Variables
filename="lernOS-ePortfolio-Guide-de"
chapters="./src/index.md ./src/1-0-Grundlagen.md ./src/2-0-Lernpfad.md ./src/2-1-Lernbereich-1.md ./src/2-1-Lernbereich-2.md ./src/2-1-Lernbereich-3.md ./src/2-1-Lernbereich-4.md ./src/2-1-Lernbereich-5.md ./src/2-1-Lernbereich-6.md ./src/2-1-Lernbereich-7.md ./src/3-0-Lessons-Learned.md ./src/4-0-Anhang.md"
